...
namespace FootballFixtures.Controllers
{
    public class NationalitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NationalityID,Nationality1")] Nationality nationality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NationalityID,Nationality1")] Nationality nationality)
        {
            if (ModelState.IsValid)
            {
